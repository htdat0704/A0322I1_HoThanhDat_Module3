                        ...
                        <div class="header">
                            ...
                            <div class="body">
                                <form action="/product" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" name="price" class="form-control" required
                                                   min="10000000" placeholder="Product price" tabindex="2" id="price" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" name="quantity" class="form-control" required min="1"
                                                   step="1" placeholder="Product quantity" tabindex="4" id="quantity" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select type="text" name="color" class="form-control" placeholder="Product color"
                                                    tabindex="4" id="color" >
